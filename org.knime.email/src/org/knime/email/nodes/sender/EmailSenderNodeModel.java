...
final class EmailSenderNodeModel extends NodeModel implements FlowVariableProvider {
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        NodeParameters.loadSettings(settings, EmailSenderNodeSettings.class).validate();
    }

    @Override
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_settings = NodeParameters.loadSettings(settings, EmailSenderNodeSettings.class);
    }

    @Override
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        NodeParameters.saveSettings(EmailSenderNodeSettings.class, m_settings, settings);
    }
