...
public class EmailReaderNodeModel extends NodeModel {
    ...
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_settings = NodeParameters.loadSettings(settings, EmailReaderNodeSettings.class);
    }

    @Override
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        NodeParameters.saveSettings(EmailReaderNodeSettings.class, m_settings, settings);
    }
