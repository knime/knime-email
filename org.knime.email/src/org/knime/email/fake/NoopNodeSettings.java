...
public final class NoopNodeSettings implements DefaultNodeSettings {
...
//        description = "When checked, a new column \"" + NoopNodeModel.COLUMN_NAME_MATCHFOUND
...
//    @Layout(OutputSection.class)
    ...
    NoopNodeSettings(final DefaultNodeSettingsContext ctx) {
    }
